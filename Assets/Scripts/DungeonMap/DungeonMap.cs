...
public class DungeonMap : SingletonMonobehaviour<DungeonMap>
{
    ...
    /// </summary>
    public void DisplayDungeoOverViewMap()
    {
        ...
        // Ensure all rooms are active so they can be displalyer
        ActivateRoomsForDisplay();

        // Disanle Small Minimap UI
    ...
    /// <summary>
    /// Ensure all room are active so they can be displayed
    /// </summary>
