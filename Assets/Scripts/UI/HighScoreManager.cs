...
public class HighScoreManager : SingletonMonobehaviour<HighScoreManager>
{
    ...
    /// <summary>
    /// Return the rank of the playerScore compared to the other high scores (return 0 if the score isn;t higher than any in the high scores list
    /// </summary>
    public int GetRank(long playerScore)
    {
        // If there are no scores currently in the list - then this score must be rank 1 - then return
